...
import { Button } from "../../../shims/ui-button";
import { Input } from "../../../shims/ui-input";
  ...
  return (
    <div className="mx-auto flex w-full max-w-lg -skew-x-3 skew-y-2 flex-col gap-2 rounded-lg bg-white py-6 transition-transform duration-300 hover:skew-x-0 hover:skew-y-0">
      ...
      <div className="flex flex-col gap-2 px-4">
        ...
        <Button
          className="group/subscribe relative cursor-pointer bg-gray-500 text-white transition-colors duration-300 hover:bg-green-600"
