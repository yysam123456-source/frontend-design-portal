...
const EmailCard = () => {
  return (
    <div className="group/email relative w-full max-w-lg rounded-lg bg-gray-50 p-6 shadow-lg backdrop-blur-sm transition-shadow duration-300 ease-in-out">
      {/* Upper card */}
      <div className="relative flex flex-col gap-4 rounded-lg border border-gray-300 bg-white p-6 transition-transform duration-200 ease-in-out group-hover/email:scale-95">
      ...
      <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-green-500 text-white opacity-0 group-hover/email:opacity-100 transition-opacity duration-300">
        <div className="flex items-center gap-2 transform scale-0 group-hover/email:scale-100 transition-transform duration-300">
