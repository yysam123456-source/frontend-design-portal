  ...
  return (
    <div className="p-4">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-4 sm:grid-rows-3">
        ...
        <BentoCard className="bg-purple-300 sm:col-span-2 sm:row-span-2">
          <div className="flex flex-col">Another Section</div>
        </BentoCard>

        <BentoCard className="s bg-violet-300">
          <div className="flex flex-col">Another Section</div>
        </BentoCard>
        ...
        <BentoCard className="bg-lime-300 sm:row-span-2">
        ...
        <BentoCard className="bg-gray-300">
          <div className="flex flex-col">Add Widget</div>
        </BentoCard>
        ...
        <BentoCard className="bg-zinc-300 sm:col-span-2">
          <div className="flex flex-col">Add Widget</div>
        </BentoCard>
      </div>
    </div>
