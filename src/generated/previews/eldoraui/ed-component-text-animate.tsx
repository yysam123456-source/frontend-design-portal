// @ts-nocheck
import * as ComponentModule from '../../vendor/eldoraui/component/text-animate'

const Component = ComponentModule.TextAnimate
const previewProps = { text: 'Eldora UI Preview', className: '', duration: 0.5, delay: 0.05 }
