// @ts-nocheck
import * as ComponentModule from '../../vendor/eldoraui/example/holographic-card-demo-2'

const Component = ComponentModule.default
const previewProps = { className: '', title: 'Holographic Card', description: 'Interactive Eldora UI preview' }
