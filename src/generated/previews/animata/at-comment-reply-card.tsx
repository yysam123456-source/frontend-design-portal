// @ts-nocheck
import Component from '../../vendor/animata/card/comment-reply-card'

const previewProps = { text: 'Preview Component', label: 'Preview Label', initialComments: [{ id: 1, user: 'Mike', text: ['This preview is generated from fallback props.'], time: 'now', avatarColor: '#e8824b' }], items: [
