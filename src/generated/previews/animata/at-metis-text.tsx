// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/text/metis-text'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', label: 'Preview Label', className: 'text-4xl font-bold' }
