// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/card/card-stack-profile'

const Component = ComponentModule.CardStackProfileMasks
const previewProps = { text: 'Preview Component', title: 'Preview Title', label: 'Preview Label', items: [
