// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/tabs/gooey-tabs'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', title: 'Preview Title', label: 'Preview Label', items: [
