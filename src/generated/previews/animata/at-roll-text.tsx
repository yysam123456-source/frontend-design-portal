// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/text/roll-text'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', label: 'Preview Label', href: '#', items: [
