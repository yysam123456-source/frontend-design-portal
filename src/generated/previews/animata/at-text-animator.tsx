// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/text/text-animator'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', title: 'Preview Title', items: [
