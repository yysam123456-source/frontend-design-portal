// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/bento-grid/three'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', className: 'text-4xl font-bold' }
