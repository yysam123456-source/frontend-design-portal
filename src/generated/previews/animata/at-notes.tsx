// @ts-nocheck
import Component from '../../vendor/animata/widget/notes'

const previewProps = { children: 'Preview Component', text: 'Preview Component', title: 'Preview Title', className: 'text-4xl font-bold' }
