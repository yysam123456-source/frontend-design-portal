// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/text/focus-blur-resolve'

const Component = ComponentModule.default
const previewProps = { text: 'Preview Component', title: 'Preview Title', className: 'text-4xl font-bold' }
