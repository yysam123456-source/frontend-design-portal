// @ts-nocheck
import Component from '../../vendor/animata/card/staggered-card'

const previewProps = { text: 'Preview Component', label: 'Preview Label', href: '#', className: 'text-4xl font-bold' }
