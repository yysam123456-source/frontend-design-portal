// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/container/animated-border-trail'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', className: 'text-4xl font-bold' }
