// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/card/subscribe-card'

const Component = ComponentModule.default
const previewProps = { text: 'Preview Component', title: 'Preview Title', label: 'Preview Label', className: 'text-4xl font-bold' }
