// @ts-nocheck
import * as ComponentModule from '../../vendor/animata/bento-grid/eight'

const Component = ComponentModule.default
const previewProps = { children: 'Preview Component', text: 'Preview Component', label: 'Preview Label', items: [
