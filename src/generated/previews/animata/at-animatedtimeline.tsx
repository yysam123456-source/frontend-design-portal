// @ts-nocheck
import Component from '../../vendor/animata/progress/animatedtimeline'

const previewProps = { text: 'Preview Component', title: 'Preview Title', description: 'This is a generated preview.', items: [
