// @ts-nocheck
import Component from '../../vendor/animata/background/interactive-grid'

const previewProps = { children: 'Preview Component', label: 'Preview Label', className: 'text-4xl font-bold' }
